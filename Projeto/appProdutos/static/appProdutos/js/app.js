var App = function() {
    ...
    var categoryScroll = {
        scrollCat: function() {
            var sidebarWrapper = document.querySelectorAll('.sidebar-wrapper li');
    ...
    function sidebarFunctionality() {
        function sidebarCloser() {
            if (window.innerWidth <= 991 ) {
                ...
                //tavares mudou o if de if !(document.querySelector('body').classList.contains('alt-menu') para a condicao atual
                if (document.querySelector('body').classList.contains('alt-menu')) {
