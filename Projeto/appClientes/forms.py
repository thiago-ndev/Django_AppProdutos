...
class EnderecoForm(forms.Form):
    cidade = forms.CharField(label="Cidade", max_length=30, widget=forms.TextInput())
    bairro = forms.CharField(label="Bairro", max_length=30, widget=forms.TextInput())
    Rua   = forms.CharField(label="Rua", max_length=20, widget=forms.TextInput())
